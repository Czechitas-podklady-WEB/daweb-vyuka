...
1. Na tlačíko se třídou `order-btn` pověste posluchač, který při kliknutí změní nápis na tlačítku na :i[Zrušit]. Zároveň přidá na prvek se třídou `drink__cup` třídu `drink__cup--selected`.
