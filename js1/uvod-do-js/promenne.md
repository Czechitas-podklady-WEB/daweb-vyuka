...
Všimněte si důležité věci: :var[document.body.innerHTML] je také proměnná. Je trochu speciální tím, že ji nemusíme sami vytvářet, neboť už ji pro nás vytvořil prohlížeč při načtení stránky. Nepíšeme už tedy před ni `const`.
