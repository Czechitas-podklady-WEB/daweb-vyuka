!(function (e, t) {
  ...
  function _(o, s) {
    var v,
      ...
      $ = {
        ...
        show: function () {
          ...
          ($.state.isVisible = !0), ee() && (z.style.visibility = 'visible');
      ...
      if (!x.isTouch || (!N && 'mousedown' !== e.type)) {
        ...
        if (!$.props.interactive || !O(z, t)) {
          if (
            ...
            if (x.isTouch) return;
            if ($.state.isVisible && $.props.trigger.indexOf('click') >= 0)
              return;
    ...
    function Ce() {
      ...
      ee() &&
        ...
        ($.popperInstance = e.createPopper(
          c,
          z,
          Object.assign({}, n, { placement: r, onFirstUpdate: A, modifiers: p })
        ));
    }
    function Te() {
      $.popperInstance &&
    ...
    function De(e) {
      if (
        ($.clearDelayTimeouts(), ae('onUntrigger', [$, e]), $.state.isVisible)
      ) {
        if (
          !(
            $.props.trigger.indexOf('mouseenter') >= 0 &&
        ...
        onAfterUpdate: function (t, n) {
          ...
          r ||
            (void 0 !== i &&
              a.followCursor !== i &&
              (d(),
              i ? (l(), !e.state.isMounted || o || s() || u()) : (c(), p())));
        },
        onMount: function () {
          e.props.followCursor && !o && (i && (f($), (i = !1)), s() || u());
        },
    ...
    (F.delegate = function (e, n) {
      ...
      function d(e) {
        if (e.target && !i) {
          ...
          if (t) {
            var r =
              t.getAttribute('data-tippy-trigger') || n.trigger || R.trigger;
            if (
              !t._tippy &&
              !(
                ('touchstart' === e.type && 'boolean' == typeof f.touch) ||
