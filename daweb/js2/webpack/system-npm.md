...
Vlastnost `dependencies` říká, jaké všechny balíčky náš projekt používá. Odborně se takovým balíčkům říká _závislosti_. V našem případě zatím žádné závislosti nemáme.
